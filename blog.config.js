...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HelloNight', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个上进的web看题手💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hellonight.top', // 网站地址
